...
function ListOrders() {
    ...
    console.log('pagination', paginateCtegories)
    useEffect(() => {
                            ...
                            <tbody>
                                <tr key={order._id}>
                                    ...
                                    <td><h5><span className={order.status === "Not processed" ? "badge bg-danger" : 
                                                    ...
                                                    order.status === "Cancelled" ? "badge bg-primary" : "badge bg-danger"
                                            } 
                                        style={{color : order.status === 'Processing' ? 'white' : 'black !important'}}>{order.status}</span></h5></td>
                                    <td>
