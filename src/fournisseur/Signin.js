...
const Signin = (props) => {
    ...
    const submitSignin = e => {
        ...
        fetch(`${API_URL}/fournisseur/signin`, {
            method: "POST",
            headers: {
        ...
        .then(res => {
            if(res.error) {
                ...
                toastr.info('Fournisseur is authenticated SuccessFully', 'Welcome', {
                    positionClass: "toast-bottom-left",
                })
        ...
        <form onSubmit={submitSignin} className="my-4"> 
            ...
            <div className="form-group">
                ...
                <div class="d-flex justify-content-between align-items-top mb-4">
                    ...
                    <div>
                        <a href="" class="small text-right text-decoration">Lost password?</a>
                    </div>
                </div>
            </div>
                        ...
                        <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">Not registered? 
                                    <Link to="/fournisseur/signup" class="fw-bold text-decoration mx-1">Create account</Link>
                                </span>
                            </div>
                        </div>
                    </div>
